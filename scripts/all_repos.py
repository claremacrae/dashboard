...
from scripts.repo_and_builds import RepoAndBuilds, RepoInfo, AppveyorConfig, TravisConfig, GitHubConfig
...
class AllRepos:
    ...
    def add_source_repo(self, user, project, branches, travis_build_info=TravisConfig(True),
                        appveyor_build_info=AppveyorConfig(), github_build_info=GitHubConfig()):
