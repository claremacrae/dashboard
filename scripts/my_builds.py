...
def add_official_approval_test_repos_cpp(builds: AllRepos) -> None:
    ...
    builds.add_forked_repo(repo, 'claremacrae', 'ApprovalTests.cpp', ['master'],
    ...
    repo = builds.add_source_repo('approvals', 'ApprovalTests.cpp.StarterProject', ['master'],
                           ...
                           GitHubBuildConfig(gh_workflows))
    builds.add_forked_repo(repo, 'claremacrae', 'ApprovalTests.cpp.StarterProject', ['master'],
    ...
    builds.add_forked_repo(repo, 'claremacrae', 'ApprovalTests.cpp.Qt', ['master'],
    ...
    builds.add_forked_repo(repo, 'claremacrae', 'ApprovalTests.cpp.Qt.StarterProject', ['master'],
...
def add_official_approval_test_repos_python(builds: AllRepos) -> None:
    ...
    builds.add_forked_repo(repo, 'claremacrae', 'ApprovalTests.Python', ['master'], None, git_hub_build_config)
    ...
    builds.add_forked_repo(repo, 'claremacrae', 'ApprovalTests.Python.PytestPlugin', ['master'], None,
...
def add_catch_repos(builds):
    ...
    builds.add_forked_repo(repo, 'claremacrae', 'Catch2', ['master'], AppveyorBuildConfig('8m77qos96rmcn6jg'))


def add_boost_ut_repos(builds):
    repo = builds.add_source_repo('boost-experimental', 'ut', ['master'])
    builds.add_forked_repo(repo, 'claremacrae', 'ut', ['master', 'clare_learning'],
...
def add_doctest_repos(builds: AllRepos) -> None:
    ...
    builds.add_forked_repo(repo, 'claremacrae', 'doctest', ['master', 'dev'], AppveyorBuildConfig('y3ylbpuv79souy6e'),
